...
const EditarPerfil = () => {
    ...
    const update = async (e) => {
        ...
        user.email == 'admin@gmail.com' ?  navigate(`/clientes`) : navigate(`/perfil/${id}`)
    };
            ...
            <div className="container_crearMascota">
                <form className="editarMascota_form" action="" method='POST' onSubmit={update}>
                    ...
                    <div className="container_campo campo_edit">
                        ...
                        <input value={Apellido} type="text" name="nombre" required onChange={(e) => setApellido(e.target.value)}></input>
                    </div>
                    <div className="container_campo">
