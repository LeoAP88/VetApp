...
const EditarMascota = () => {
    ...
    const update = async (e) => {
      ...
      const getMascota = async () => {
        ...
        const mascotaDoc = await getDoc(doc(db, `/Clientes/${idUsuario}/Mascotas/${idMascota}`));
        ...
        <div className="container_crearMascota">
            <form className="crearMascota_form" action="" method='POST'>
                ...
                <div className="container_campo_select">
                    ...
                    <select value={Sexo} className="select_especie" required name="sexo" id="sexo" onChange={(e) => setSexo(e.target.value)}>
