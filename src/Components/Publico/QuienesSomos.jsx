    ...
    <div>
      ...
      <div>
        ...
        <div className="row row-cols-1 row-cols-md-2 g-4">
          <div className="col">
            <div className="card">
              <img src="./5.jpeg" className="card-img-top" alt="Responsive image" />
          ...
          <div className="col">
            <div className="card">
              <img src="./4.jpeg" className="card-img-top" alt="Responsive image" />
              <div className="card-body">
          ...
          <div className="col">
            <div className="card">
              <img src="./dx2.jpg" className="card-img-top" alt="Responsive image" />
              <div className="card-body">
          ...
          <div className="col">
            <div className="card">
              <img src="./RV.jpg" className="card-img-top" alt="Responsive image" />
              <div className="card-body">
